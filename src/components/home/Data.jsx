...
const Data = () => {
  ...
  return (
    <div className='home__data'>
      <h1 className='home__title' style={{fontSize:"4rem"}}>I'm</h1>
      <h1 className='home__title' style={{fontSize:"3rem", color:"white"}}>
      ...
      <p className='home__description'>
        I'm a Developer with proficiency in Android Developement, having
        knowledge of Front-End and coupled with expertise in Machine Learning.
      </p>
